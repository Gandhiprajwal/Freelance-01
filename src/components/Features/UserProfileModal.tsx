      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto my-auto"
          >
            {/* Header */}
            ...
            {success && (
              <motion.div
                ...
                className="p-4 bg-green-50 border-l-4 border-green-400 text-green-700"
              >
            ...
            {error && (
              <motion.div
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="p-4 bg-red-50 border-l-4 border-red-400 text-red-700 flex items-center space-x-2"
              >
            ...
            <form onSubmit={handleSubmit} className="p-12 space-y-6">
              ...
              <div className="text-center">
                <div className="relative inline-block">
                  <div className="w-20 h-20 bg-orange-500 rounded-full flex items-center justify-center overflow-hidden mx-auto">
                    {formData.avatar_url ? (
                      <img
                  ...
                  <button
                    type="button"
                    className="absolute bottom-0 right-0 p-1 bg-orange-500 text-white rounded-full hover:bg-orange-600 transition-colors"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
